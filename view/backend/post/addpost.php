...
<div class="col-md-6 offset-md-3 mt-5 bg-dark p-5 text-white form-container">
    ...
    <h2 class="mt-5"> <i class="fa-solid fa-circle-plus"></i> Add New Post</h2>
    ...
    <form class="mt-5" action="../../controller/PostController.php" enctype="multipart/form-data"  method="post">
        <div class="form-group ">
            <div class="row">
                ...
                <input type="text" class="form-control col-8" name="title" id="title" aria-describedby="emailHelp" placeholder="Enter Your title...">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <textarea name="description" class="form-control col-8" id="description" cols="30" rows="10" placeholder="Enter Your Description..."></textarea>
